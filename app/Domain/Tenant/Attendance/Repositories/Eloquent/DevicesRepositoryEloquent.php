<?php
namespace App\Domain\Tenant\Attendance\Repositories\Eloquent;
...
class DevicesRepositoryEloquent extends BaseRepository implements DevicesRepository
{
    /**
    ...
    protected $allowedFilters = [
        'firebase_token','qr_code','device_type','device_details','last_active_request','user_id','active'
    ];
