<?php
namespace App\Domain\Tenant\Employee\Repositories\Eloquent;
...
class EmployeeDevicesRepositoryEloquent extends BaseRepository implements EmployeeDevicesRepository
{
    /**
