...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private $repositories = [
        //\App\Domain\Tenant\General\Repositories\Contracts\DashboardRepository::class => \App\Domain\Tenant\General\Repositories\Eloquent\DashboardRepositoryEloquent::class,
